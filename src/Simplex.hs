...
-- 3D Gradient Collection
grad3D :: [Gradient]
grad3D  = [Grad 1 1 0, Grad 1 1 0, Grad 1 (-1) 0, Grad (-1) (-1) 0,
...
F2 :: Float; F2 = 0.5 * (sqrt 3.0) - 1.0) 
G2 :: Float; G2 = (3.0 - (sqrt 3.0))/6.0;
F3 :: Float; F3 = 1.0 / 3.0
G3 :: Float; G3 = 1.0 / 6.0